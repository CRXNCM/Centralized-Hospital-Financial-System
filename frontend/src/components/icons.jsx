...
export function IconClock({ className = "w-5 h-5" }) {
  return IconHistory({ className });
}

export function IconHospital({ className = "w-8 h-8" }) {
  return (
...
export function IconMobilePay({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function IconManager({ className = "w-6 h-6" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function IconReception({ className = "w-6 h-6" }) {
  return IconPayment({ className });
}
...
export function IconUserOff({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path
        strokeLinecap="round"
