export default function ConfirmActionModal({
  ...
  confirmClassName = "rounded-xl bg-[#F43F5E] px-5 py-2.5 text-sm font-bold text-white hover:bg-[#fb7185]",
  onConfirm,
  onCancel,
}) {
  if (!open) return null;
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      >
        ...
        <p className="mt-3 text-sm leading-relaxed text-[#94A3B8]">{message}</p>
